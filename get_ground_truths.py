...
model = torch.hub.load('ultralytics/yolov5', 'custom', path='runs/train/KITTI_med_evolve/weights/best.pt')

# Set the path to the folder containing images
main_folder = 'frames_for_attacks'
...
label_folder = os.path.join(main_folder, 'labels1')
